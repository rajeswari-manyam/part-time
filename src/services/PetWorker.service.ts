 ...
 * @param formData FormData (includes images)
 */
export const addPetService = async (
  ...
  try {
    ...
    return {
      success: false,
      message: "Failed to add pet service"
    };
  }
};
...
/**
 * Fetch nearby pet service workers
...
/**
 * Fetch pet service by ID
 * @param serviceId string
 * @returns Promise<PetWorkerResponse>
 */
export const getPetServiceById = async (
  serviceId: string
): Promise<PetWorkerResponse> => {
  if (!serviceId) {
    throw new Error("Pet service ID is required");
  }

  try {
    const response = await fetch(
      `${API_BASE_URL}/getPetServiceById/${serviceId}`,
      {
        method: "GET",
        redirect: "follow"
      }
 ...
 * @param serviceId string
 * @param formData FormData (can include images)
 * @returns Promise<PetWorkerResponse>
 */
export const updatePetServiceById = async (
  ...
  try {
    const response = await fetch(
      `${API_BASE_URL}/updatePetService/${serviceId}`,
      {
        method: "PUT",
        body: formData,
        redirect: "follow"
    ...
    return {
      success: false,
      message: "Failed to update pet service"
    };
  }
};
/**
 * Delete pet service by ID
 * @param serviceId string
 * @returns Promise<PetWorkerResponse>
 */
export const deletePetServiceById = async (
  serviceId: string
): Promise<PetWorkerResponse> => {
  if (!serviceId) {
    throw new Error("Pet service ID is required");
  ...
  try {
    const response = await fetch(
      `${API_BASE_URL}/deletePetService/${serviceId}`,
      {
        method: "DELETE",
        redirect: "follow"
      }
    ...
    return {
      success: false,
      message: "Failed to delete pet service"
    };
  }
};
