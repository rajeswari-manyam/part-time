...
import Button from "../components/ui/Buttons";
import typography from "../styles/typography";
import { getUserById, updateUserById } from "../services/api.service";
  ...
  return (
    <div className="min-h-screen p-4 bg-gray-50">
      <div className="max-w-xl mx-auto bg-white p-6 rounded-xl shadow">
        ...
        <div className="my-2">
          <label>Phone</label>
          <input value={phone} disabled className="w-full border px-2 py-1 rounded bg-gray-100" />
        </div>
        ...
        <div className="flex gap-2 mt-4">
          {isEditing && (
            <>
              ...
              <Button variant="gradient-blue" onClick={handleSave} disabled={isSaving}>Save</Button>
            </>
          )}
