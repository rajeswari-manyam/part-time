                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <div>
                            ...
                            <input type="text" name="area" value={formData.area}
                                onChange={handleInputChange} placeholder="e.g. Jayanagar" className={inputBase} />
                        </div>
                        <div>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        ...
                        <div>
                            ...
                            <input type="text" name="pincode" value={formData.pincode}
                                onChange={handleInputChange} placeholder="e.g. 560041" className={inputBase} />
                        </div>
                    </div>

                    <div className="bg-pink-50 border border-pink-200 rounded-xl p-3">
                        <p className={`${typography.body.small} text-pink-800`}>
                            ...
                            <div className="flex flex-col items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className={`${typography.body.small} text-gray-500 mt-1`}>
                                        Upload past work or portfolio photos (max 5 images)
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-3 gap-3 mt-4">
                            {existingImages.map((url, i) => (
                                <div key={`ex-${i}`} className="relative aspect-square">
                                    ...
                                    <span className={`absolute bottom-2 left-2 bg-pink-600 text-white ${typography.fontSize.xs} px-2 py-0.5 rounded-full`}>
                                        Saved
                                    </span>
                                </div>
                            ))}
                            {imagePreviews.map((preview, i) => (
                                <div key={`new-${i}`} className="relative aspect-square">
                                    <img src={preview} alt={`Preview ${i + 1}`}
                                        className="w-full h-full object-cover rounded-xl border-2 border-pink-400" />
                ...
                <div className="flex gap-4 pt-2 pb-8">
                    <button
                        ...
                        className={`flex-1 px-6 py-3.5 rounded-xl font-semibold text-white transition-all ${loading
                            ...
                            : 'bg-pink-600 hover:bg-pink-700 active:bg-pink-800 shadow-md hover:shadow-lg'
