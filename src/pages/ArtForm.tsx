...
import { addCreativeArtService, getCreativeArtServiceById, updateCreativeArtService } from "../services/Creative.service";
...
// ── Pull creative art subcategories from JSON ───────────────────────────────
...
const ArtForm: React.FC = () => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            payload.append('category', 'Creative & Art');
            ...
            if (isEditMode && editId) {
                ...
                await updateCreativeArtService(editId, updateData);
                setSuccessMessage('Service updated successfully!');
                setTimeout(() => navigate('/listed-jobs'), 1500);
            } else {
                await addCreativeArtService(payload);
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        ...
                        <div>
                            ...
                            <input type="text" name="pincode" value={formData.pincode}
                                onChange={handleInputChange} placeholder="e.g. 560095" className={inputBase} />
                        </div>
                    </div>
                            ...
                            <div className="flex flex-col items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className={`${typography.body.small} text-gray-500 mt-1`}>
                                        Upload your artwork or portfolio photos (max 5 images)
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-3 gap-3 mt-4">
                            {existingImages.map((url, i) => (
                                <div key={`ex-${i}`} className="relative aspect-square">
                                    ...
                                    <span className={`absolute bottom-2 left-2 bg-amber-600 text-white ${typography.fontSize.xs} px-2 py-0.5 rounded-full`}>
                                        Saved
                                    </span>
                                </div>
                            ))}
                ...
                <div className="flex gap-4 pt-2 pb-8">
                    <button
                        ...
                        className={`flex-1 px-6 py-3.5 rounded-xl font-semibold text-white transition-all ${loading
                            ...
                            : 'bg-amber-600 hover:bg-amber-700 active:bg-amber-800 shadow-md hover:shadow-lg'
