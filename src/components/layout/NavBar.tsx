      ...
      <div className="max-w-[1400px] mx-auto px-6 sm:px-8 lg:px-12">
        <div className="flex justify-between items-center h-20">
          ...
          <div className={`hidden lg:flex gap-10 text-gray-700 ${typography.nav.menuItem}`}>
            ...
            <Link to="/services" className="hover:text-blue-600 transition">All Services</Link>
          ...
          <div className="hidden lg:flex items-center gap-8">
            ...
            <div className="flex items-center gap-8">
              ...
              <Button variant="gradient-blue" to="/login" size="md">
                Login / Sign Up
              </Button>
            </div>
          </div>
        ...
        {isMobileMenuOpen && (
          <div className="lg:hidden border-t border-gray-200 py-6 space-y-5">
            ...
            <div className="flex flex-col gap-4 pt-2">
              ...
              <Button variant="gradient-blue" to="/login" fullWidth size="md">
                Login / Sign Up
              </Button>
            </div>
          </div>
